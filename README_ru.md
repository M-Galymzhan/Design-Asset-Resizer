...
- **PWA и работа оффлайн**: Полная поддержка оффлайн-режима через Service Workers. Приложение можно установить в один клик как родное на ПК и мобильные устройства (добавлен динамический манифест).
- **Обширный экспорт**: Автоматически генерирует ZIP-архив с более чем 40 ресурсами:
  - Фавиконки
  - Android mipmap иконки
  - iOS AppIcons
  - Изображения для соцсетей (в форматах PNG и оптимизированном WebP)
  - Иконки для PWA
- **Произвольный размер**: Возможность ввести любые кастомные размеры (ширину и высоту) и получить соответствующие PNG и WebP файлы на выходе.
