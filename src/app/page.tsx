  ...
  return (
    <div className="min-h-screen relative overflow-hidden transition-colors duration-200">
      ...
      <div className="relative z-10">
        ...
        <a
          href="https://github.com/M-Galymzhan/Design-Asset-Resizer"
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition flex items-center justify-center text-slate-800 dark:text-slate-200"
